...
def get(path: str, params: dict = None, timeout: int = None):
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=timeout or _TIMEOUT, context=_CTX) as resp:
            return json.loads(resp.read())
    except Exception:
        return None


def post(path: str, body: dict = None, timeout: int = None):
