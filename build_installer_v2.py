...
# ── 1. Directories ───────────────────────────────────────────────────
parts.append(section("1 · DIRECTORIES"))
parts.append(textwrap.dedent("""\
...
# ── 2. Apt repositories ─────────────────────────────────────────────
parts.append(section("2 · APT REPOSITORIES"))
parts.append(textwrap.dedent("""\
...
# ── 3. Base dependencies ─────────────────────────────────────────────
parts.append(section("3 · BASE DEPENDENCIES"))
parts.append(textwrap.dedent("""\
...
# ── 4. User groups ───────────────────────────────────────────────────
parts.append(section("4 · USER GROUPS"))
parts.append(textwrap.dedent("""\
...
# ── 5. Clone / update repo ──────────────────────────────────────────
parts.append(section("5 · CLONE / UPDATE REPO"))
parts.append(textwrap.dedent("""\
...
# ── 6. Python venv ──────────────────────────────────────────────────
parts.append(section("6 · PYTHON VIRTUAL ENVIRONMENT"))
parts.append(textwrap.dedent("""\
...
# ── 7. SSL certificate ──────────────────────────────────────────────
parts.append(section("7 · SSL CERTIFICATE"))
parts.append(textwrap.dedent("""\
...
# ── 8. Systemd service ──────────────────────────────────────────────
parts.append(section("8 · SYSTEMD SERVICE"))
parts.append(textwrap.dedent("""\
...
# ── 9. Netplan — eth1 static IP ─────────────────────────────────────
parts.append(section("9 · NETPLAN — ETH1 STATIC IP"))
parts.append(textwrap.dedent("""\
...
# ── 10. Dnsmasq ─────────────────────────────────────────────────────
parts.append(section("10 · DNSMASQ — DHCP FOR ETH1"))
parts.append(textwrap.dedent("""\
...
# ── 11. InfluxDB setup ──────────────────────────────────────────────
parts.append(section("11 · INFLUXDB — INITIAL SETUP"))
parts.append(textwrap.dedent("""\
...
# ── 12. Grafana ──────────────────────────────────────────────────────
parts.append(section("12 · GRAFANA"))
parts.append(textwrap.dedent("""\
...
# ── 13. Cockpit ──────────────────────────────────────────────────────
parts.append(section("13 · COCKPIT — IFRAME EMBED"))
parts.append(textwrap.dedent("""\
...
# ── 14. Kismet ───────────────────────────────────────────────────────
parts.append(section("14 · KISMET — LOG DIRECTORY"))
parts.append(textwrap.dedent("""\
...
# ── 15. Sudoers ──────────────────────────────────────────────────────
parts.append(section("15 · SUDOERS — SERVICE CONTROL"))
parts.append(textwrap.dedent("""\
...
# ── 16. Pktvisor ─────────────────────────────────────────────────────
parts.append(section("16 · PKTVISOR"))
parts.append(textwrap.dedent("""\
...
# ── 17. Ollama ───────────────────────────────────────────────────────
parts.append(section("17 · OLLAMA — LOCAL AI"))
parts.append(textwrap.dedent("""\
...
# ── 18. DHCP options file ────────────────────────────────────────────
parts.append(section("18 · DATA FILES"))
parts.append(textwrap.dedent("""\
...
# ── 19. .gitignore ───────────────────────────────────────────────────
parts.append(section("19 · GITIGNORE"))
parts.append(textwrap.dedent("""\
...
# ── 20. Fix ownership ───────────────────────────────────────────────
parts.append(section("20 · FINAL OWNERSHIP"))
parts.append(textwrap.dedent("""\
...
# ── 21. Assets check ────────────────────────────────────────────────
parts.append(section("21 · ASSETS CHECK"))
parts.append(textwrap.dedent("""\
...
# ── 22. Start services ──────────────────────────────────────────────
parts.append(section("22 · START SERVICES"))
parts.append(textwrap.dedent("""\
...
# ── 23. Verification ─────────────────────────────────────────────────
parts.append(section("23 · VERIFICATION"))
parts.append(textwrap.dedent("""\
    echo ""
    echo "╔══════════════════════════════════════════════╗"
